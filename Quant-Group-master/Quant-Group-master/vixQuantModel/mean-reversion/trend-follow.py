...
# Naoki Nagai, 2015
#
# See: https://www.quantopian.com/posts/trend-follow-algo
#      https://www.linkedin.com/in/naokinagai/
#      http://www.wired.co.uk/article/trading-places-the-rise-of-the-diy-hedge-fund
#      http://www.hedgeco.net/news/04/2017/trading-places-the-rise-of-the-diy-hedge-fund.html
#####################################################################
...
# Entry signal: Regression line slope exceeds 10% per year & past draw-down and crosses the regression line
# Profit take : 1.96 standard deviation (95% bollinger band)
# Stop loss   : If draw-down exceeds the max draw-down at the time of entry, stop loss. Check every 5 minutes
...
def initialize (context):
	...
	context.maxdrawdown = 0.10   # Avoid security with too much draw-down
...
# Calculate the slopes for different assets    
def regression (context, data):
	...
	for s in context.security_list:
		...
		slope_min = max(dd, context.minimumreturn)   # Max draw-down and minimum return 
...
# We are entering into position when slope exceeds the draw-down
# If we experience the draw-down again, stop loss

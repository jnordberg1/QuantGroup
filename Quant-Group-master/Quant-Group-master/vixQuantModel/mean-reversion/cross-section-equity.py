...
def initialize (context):
	...
	# Schedule our re-balance function
...
def make_pipeline ():
	...
	# combined ranking system. We'll use these as our trade-able universe each
	# day.
...
def before_trading_start (context, data):
	...
	# Note: this is a data-frame where the index is the SIDs for all
	# securities to pass my screen and the columns are the factors
	# added to the pipeline object above
	context.pipeline_data = algo.pipeline_output('long_short_equity_template')
	
	# This data-frame will contain all of our risk loadings
